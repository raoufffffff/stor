...
const BestOfferCard = ({item}) => {
  ...
  return (
    ...
    className="min-w-[38%] pb-1.5 relative my-2 mx-0.5 flex flex-col md:min-w-[15%]  md:mx-2 border bg-white border-gray-200 rounded-lg overflow-hidden max-h-[200px] min-h-[200px] hover:shadow-xl hover:scale-105"
  >
    {existingItem?.q > 0 && (
